...
if($_SERVER['REQUEST_METHOD']=="POST"&&isset($_POST['traHang'])){
    ...
    mysqli_query($con,"INSERT INTO yeu_cau_khach_hang (ma_chi_tiet,ma_don_hang,ngay_yeu_cau,yeu_cau,ly_do) VALUES(".$mact.",".$madh.",current_timestamp(),'yêu cầu trả hàng','".$lydo."') ");
