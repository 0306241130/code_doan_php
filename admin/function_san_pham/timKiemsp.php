...
if(isset($_POST['tensp'])){
    ...
    $mausac="";
    $size="";
    $result=mysqli_query($con,"SELECT * FROM san_pham JOIN thuong_hieu ON san_pham.ma_thuong_hieu=thuong_hieu.ma_thuong_hieu WHERE ten_san_pham  LIKE '%".$tensp."%'  ORDER BY san_pham.ma_san_pham");
